...
namespace HEIF
{
    ...
    enum class ErrorCode
    {
        ...
        DECODER_CONFIGURATION_ERROR, //5
        FILE_HEADER_ERROR,
        FILE_OPEN_ERROR,
        FILE_READ_ERROR,
        FTYP_ALREADY_WRITTEN,
        HIDDEN_PRIMARY_ITEM, //10
        INVALID_CONTEXT_ID,
        INVALID_FUNCTION_PARAMETER,
        INVALID_GROUP_ID,
        INVALID_ITEM_ID,
        INVALID_MEDIADATA_ID, //15
        INVALID_METADATAITEM_ID,
        INVALID_MEDIA_FORMAT,
        INVALID_PROPERTY_INDEX,
        INVALID_REFERENCE_COUNT,
        INVALID_SAMPLE_DESCRIPTION_INDEX, //20
        INVALID_SEQUENCE_ID,
        INVALID_DECODER_CONFIG_ID, //22
